...
export default function HeaderOfCategory({ title, img }) {
	const back =
		'opacity-0 mb-8 mt-[135px] md:mt-[92px] relative bg-[url("' + img + '")] bg-cover bg-left w-full h-[250px] flex justify-center items-center'

	console.log(back)
	return (
		<motion.header animate={{ opacity: [0, 1], y: [50, 0] }} className={back}>
