...
export default function HeaderOfCategory({ title }) {
	return (
		<motion.header
			...
			className="opacity-0 mb-8 mt-[130px] md:mt-[90px] relative bg-[url('https://media.graphassets.com/ooT6x01DQXqZ7hfBdQUs')] bg-cover bg-left w-full h-[250px] flex justify-center items-center"
		>
