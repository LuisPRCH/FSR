...
export default function HeaderOfCategory({ title, img }) {
	return (
		<motion.header
			animate={{ opacity: [0, 1], y: [50, 0] }}
			className='opacity-0 mb-8 mt-[135px] md:mt-[92px] relative bg-[url("https://media.graphassets.com/T04RbgjzSsScg07fziCF")] bg-cover bg-left w-full h-[250px] flex justify-center items-center'
		>
